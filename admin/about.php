...
<h1 style="visibility: visible;">LinkedIn Auto Publish (V <?php echo xyz_lnap_plugin_get_version(); ?>)</h1>

<div style="width: 99%">
<p style="text-align: justify">
LinkedIn Auto Publish automatically publishes posts from your blog to your LinkedIn pages. It allows you to filter posts based on post-types and categories.
 LinkedIn Auto Publish is developed and maintained by <a href="http://xyzscripts.com">xyzscripts</a>.</p>

 

<p style="text-align: justify">
	If you would like to have more features , please try <a
		href="http://xyzscripts.com/wordpress-plugins/linkedin-auto-publish/features"
		target="_blank">XYZ LinkedIn Auto Publish</a> which is a premium version of this
