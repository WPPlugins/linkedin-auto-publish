...
function xyz_lnap_add_admin_scripts()
{
	...
	wp_register_script( 'xyz_notice_script', plugins_url('linkedin-auto-publish/js/notice.js') );
	wp_enqueue_script( 'xyz_notice_script' );
	
	wp_register_style('xyz_lnap_style', plugins_url('linkedin-auto-publish/admin/style.css'));
...
{
	add_menu_page('LinkedIn Auto Publish - Manage settings', 'LinkedIn Auto Publish', 'manage_options', 'linkedin-auto-publish-settings', 'xyz_lnap_settings');
